    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row" style="font-weight:bold">
          <div class="col-md-12 mb-0"><a href="index.php">หน้าหลัก</a> <span class="mx-2 mb-0">/</span> <a href="store.php">รายการสินค้า</a> <span class="mx-2 mb-0">/</span> <strong class="text-black"><?php echo $data[0]['item_title'] ?></strong></div>
        </div>
      </div>
    </div>
              ...
              <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                ...
                <table class="table custom-table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>DELIVERY FEES</td>
                      <?php if ($data[0]['item_price'] >= 150) {
                        echo "<td class='bg-light'>FREE</td>";
                      } else {
                        echo "<td class='bg-light'>30 ฿</td>";
                      }
                      ?>
                    </tr>
                </table>
